...
namespace CreativaSL.Dll.Kymo.Datos
{
    ...
    {
        public RR_AvisoPrivacidad ObtenerDatosPagAvisos(RR_AvisoPrivacidad Datos)
        {
            try
            {
                RR_AvisoPrivacidad datos = new RR_AvisoPrivacidad();
                DataSet ds = SqlHelper.ExecuteDataset(Datos.Conexion, "RR_spCSLDB_get_AvisoPrivacidadDatosGeneralesWeb");
                if(ds != null)
                {
