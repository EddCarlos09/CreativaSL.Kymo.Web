...
<div class="breadcumb-area breadcumb-6 overlay pos-rltv">
    ...
    <div class="account-area ptb-80">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-xs-12 lr2">
                            ...
                            <div class=" col-md-8">
                                <div class="login-reg">
                                    ...
                                    <div class="input-box mb-20 col-md-6">
                                        ...
                                        <select name="mb-20" id="cmbGenero">
                                    ...
                                    <div class="input-box mb-20 col-md-6">
                                        ...
                                        <select name="mb-20" id="cmbEstado">
                                            <option value="">C.D. MX.</option>
                                    ...
                                    <div class="input-box mb-20 col-md-6">
                                        ...
                                        <select name="mb-20" id="cmbMunicipio">
                                            <option value="">Seleccione</option>
                                            <option value="2">Delegacion 1</option>
                                            <option value="4">Delegacion 2</option>
                                        </select>
                                    </div>
                                    <div class="input-box mb-20 col-md-6">
                            ...
                            <div class=" col-md-4">
                                <div class="login-reg">
                                    ...
                                    <div class="input-box mb-20 col-md-12">
                                        ...
                                        <input type="text" name="Telefono" id="Telefono" value="" placeholder="">
                                    </div>

                                    <div class="input-box mb-20 col-md-12">
                                        <label class="control-label">Correo Electrónico</label>
                                        <input type="text" name="Correo" id="Correo" value="" placeholder="">
                                    </div>
                                    <div class="input-box mb-20 col-md-12">
                                    ...
                                    <div class=" mb-20 col-md-12 col-xs-12">
                                        <input type="checkbox" name="CkRecibir" id="CkRecibir" value="" style="width: 15px;"><label style="width: 250px; padding-left: 20px;">Quiero recibir correo electrónico ofertas y novedades</label>
                                    </div>
                                </div>
                            </div>
