...
{
    /// <summary>
    /// Definición de datos para la página FAQ
    /// </summary>
    public class CH_FAQ
    {
        /// <summary>
        ...
        public CH_FAQ()
        {
            ...
            _ListaFaqs = new List<CH_SeccionB>();
        }
        ...
        private List<CH_SeccionB> _ListaFaqs;
        /// <summary>
        /// Lista que contiene las preguntas frecuentes a mostrar en la página Web
        /// </summary>
        public List<CH_SeccionB> ListaFaqs
        {
            get { return _ListaFaqs; }
            set { _ListaFaqs = value; }
        }
